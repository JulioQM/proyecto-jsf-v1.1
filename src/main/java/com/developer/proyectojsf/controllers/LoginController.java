...
public class LoginController {
	...
	public void ingreso() {
		if(usuario.equals("jc") && password.equals("12345")) {
			FacesContext.getCurrentInstance().addMessage("formLogin:txtUsario", new FacesMessage(FacesMessage.SEVERITY_INFO,"usuario correcto",""));
		}else {
			FacesContext.getCurrentInstance().addMessage("formLogin:txtUsario", new FacesMessage(FacesMessage.SEVERITY_ERROR,"usuario incorrecto",""));
		}
	}
